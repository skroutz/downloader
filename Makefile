...
#   make docker-image-build - builds the docker image to the local registry
#   make docker-clean       - removes the `docker-build/` directory and its contents
#   make docker-build       - builds the current code under the `docker-build/` directory
